- [Part 2. 문화](#part-2-문화)
  ...
  - [Ch4. 공정 사회를 위한 엔지니어링](#ch4-공정-사회를-위한-엔지니어링)
    ...
    - [4.4 다양성 실천하기](#44-다양성-실천하기)
    - [4.5 단일한 접근 방식 거부하기](#45-단일한-접근-방식-거부하기)
    - [4.6 올바른 프로세스 확립하기](#46-올바른-프로세스-확립하기)
    - [4.7 가치 vs. 결과](#47-가치-vs-결과)
    - [4.8 관심을 잃지 말고 전진하자](#48-관심을-잃지-말고-전진하자)
  - [Ch5. 팀 이끌기](#ch5-팀-이끌기)
    - [5.1 관리자와 테크 리드](#51-관리자와-테크-리드)
      - [5.1.1 엔지니어링 관리자](#511-엔지니어링-관리자)
      - [5.1.2 테크 리드](#512-테크-리드)
      - [5.1.3 테크 리드 매니저](#513-테크-리드-매니저)
    - [5.2 개인 기여자에서 리더로](#52-개인-기여자에서-리더로)
      - [5.2.1 두려워 해야할 건 오직 "전부"다](#521-두려워-해야할-건-오직-전부다)
      - [5.2.2 섬기는 리더십](#522-섬기는-리더십)
    - [5.3 엔지니어링 관리자](#53-엔지니어링-관리자)
    - [5.4 안티 패턴](#54-안티-패턴)
    - [5.5 올바른 패턴](#55-올바른-패턴)
...
- 형평성과 공정성
- 후보자 중 여성 혹은 흑인, 다른 소수자가 포함되어 있는가? 
...
- 공정성에 의문을 제기할 수 있는 질문들
  - 기존의 평가가 향후 성과를 예측하는 척도인가?
  - 성과 평가가 다음 관리자에게 편견을 주지 않은지?
  - 성과 평가 점수가 회사 전체적으로 표준화 된 것인지?
...
구글에서는 리더 역할을 두가지로 구분하여 생각함. `관리자(manager)`와 `테크리드(tech lead)`

### 5.1 관리자와 테크 리드

관리자, 테크리드 모두 엔지니어링 팀의 성장과 생산성에 큰 영향을 주지만 관리자에게는 대인 관계 측면에서의 기술(people skill)이 더 많이 요구됨. 
...
또한 팀에서 만드는 제품의 사업적 요구까지 충족시켜야 함. 

#### 5.1.2 테크 리드

제품의 기술적인 면, 기술과 관련된 결정과 선택, 아키텍처, 우선순위, 성능과 일반적인 프로젝트 관리 

규모가 큰 팀일 경우 별도의 프로그램 관리자(program manager)를 두어 프로젝트 관리를 지원하도록 함.

#### 5.1.3 테크 리드 매니저

### 5.2 개인 기여자에서 리더로

#### 5.2.1 두려워 해야할 건 오직 "전부"다 

- 대부분의 사람은 관리자가 되기를 싫어함.
- 경력의 대부분을 코딩하며 보낸 사람이 갑자기 관리를 하게되면 오늘 한 일이 하나도 없다고 생각하게 됨.
- 피터의 법칙 : **자신의 무능력이 드러나는 직급**까지 가게 됨. 
...
- 만만한 사람 고용하기 
  - 나보다 부족하고 의욕이 적은 사람을 고용하면 안됨.
  - 똑똑하고 나를 대체할 역량을 가진 사람을 적극적으로 뽑아야 함. 
  - 스스로 할 일을 찾고 확장하며, 일부는 스스로 팀을 이끌고 싶어할 것임. 
  - 나에게 도전한다라고 생각하기 보다는 팀을 하나로 더 꾸릴 기회라고 생각하기. 
- 저성과자 방치하기
  - `희망은 전략이 아니다`
  - 저성과자를 효과적으로 지도하는 방법.
    - 존중, 겸손, 신뢰
    - 기간을 정하고 아주 구체적인 목표 제시하기
- 사람 문제 무시하기
- 만인의 친구되기
- 채용 기준 다협하기 
- 팀을 어린이처럼 대하기
